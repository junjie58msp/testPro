...
if __name__ == '__main__':
    ...
    print 'success'
    driver = wda.Client('http://localhost:8100')
    setting_session = driver.session('com.apple.mobilephone')
    setting_session(nameContains=u"最近通话").click_exists(5)
    # setting_session(nameContains=u"155 2127 5338").click_exists(5)
    # time.sleep(3)
    # setting_session.tap(187, 540)
    # time.sleep(3)
    setting_session(nameContains=u"(020) 3820 0675").click_exists(5)
    time.sleep(5)
    setting_session.tap(187, 540)
